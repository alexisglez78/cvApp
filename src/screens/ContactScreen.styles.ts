...
export const styles = StyleSheet.create({
  ...
  headerIcon: { width: 48, height: 48, borderRadius: 12, backgroundColor: Colors.primary + '30', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Colors.primary + '60' },
  headerTitle: { fontSize: 28, fontWeight: '800', color: Colors.text },
  headerSub: { fontSize: 13, color: Colors.primaryLight, marginTop: 2, fontWeight: '600' },
